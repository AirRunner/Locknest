...
public class LocationTracker extends AppCompatActivity implements
    ...
    public void onExplanationNeeded(List<String> permissionsToExplain) {
        Toast.makeText(this, "We need your permission for accessing your location",
    ...
    private class LocationChangeListeningActivityLocationCallback<LocationChangeListeningActivity>
        ...
        public void onSuccess(LocationEngineResult result) {
            ...
            if (activity != null) {
                ...
                Toast.makeText(LocationTracker.this, "New location" +
        ...
        public void onFailure(@NonNull Exception exception) {
            LocationChangeListeningActivity activity = activityWeakReference.get();
            if (activity != null) {
                Toast.makeText(LocationTracker.this, exception.getLocalizedMessage(),
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
